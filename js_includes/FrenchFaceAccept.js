...
jqueryWidget: {
    _init: function () {
        ...
        if (typeof(this.hasCorrect) == "string") {
            ...
            assert(foundIt, "Value of 'hasCorrect' option not recognized in FrenchFaceJudgment");
        }
        ...
        if (! (this.hasCorrect === false))
            assert(typeof(this.hasCorrect) == "number" && this.hasCorrect < this.answers.length,
                   "Bad index for correct answer in FrenchFaceJudgment");
        ...
        for (var i = 0; i < this.orderedAnswers.length; ++i) {
            ...
            ans = "<img src="+ans+"><br><p>Appuie sur "+m+"</p>";
