...
jqueryWidget: {
    _init: function () {
        ...
        if (this.transfer == "click") {
            this.continueMessage = dget(this.options, "continueMessage", "Entraînement");
            this.consentRequired = dget(this.options, "consentRequired", false);
            this.consentMessage = dget(this.options, "consentMessage", "J'ai lu ce qui précède et accepte de faire l'expérienc.");
